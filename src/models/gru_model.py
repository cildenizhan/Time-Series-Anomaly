"""
GRU tabanli zaman serisi anomali tespit modeli.
"""
import numpy as np
...
class GRUModel(BaseModel):
    """
    Iki katmanli GRU modeli.
    LSTM'e gore daha az parametre ile benzer performans saglar.
    """
    ...
    def build(self, input_shape: tuple) -> None:
        ...
        self.model = keras.Model(inputs=inp, outputs=out, name="GRUAnomalyDetector")
        self.model.compile(
            optimizer="adam",
